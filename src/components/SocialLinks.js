    ...
    <StyledWrapper>
      <ul className="example-2">
        <li className="icon-content">
          <a href="https://linkedin.com/in/your-profile" aria-label="LinkedIn" data-social="linkedin">
        ...
        <li className="icon-content">
          <a href="https://github.com/your-username" aria-label="GitHub" data-social="github">
            <div className="filled" />
